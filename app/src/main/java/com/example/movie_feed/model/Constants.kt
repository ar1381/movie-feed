...
object Constants {
    ...
    const val STS_DEFAULT = "Something went wrong"
    const val NETWORK_FAILURE = "You are not connected to the internet. Make sure your network connection and try again.or disconnect vpn service"
